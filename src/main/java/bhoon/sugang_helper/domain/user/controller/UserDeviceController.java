...
public class UserDeviceController {
  ...
  @GetMapping
  public ResponseEntity<CommonResponse<java.util.List<bhoon.sugang_helper.domain.user.response.UserDeviceResponse>>> getUserDevices() {
    bhoon.sugang_helper.domain.user.entity.User user = userDeviceService.getCurrentUserOrThrow();
    return ResponseEntity.ok(CommonResponse.success(userDeviceService.getUserDevices(user.getId()), "기기 목록을 조회했습니다."));
  }
